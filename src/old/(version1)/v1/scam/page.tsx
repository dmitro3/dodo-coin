...
import ScamAction from "@/old/(version1)/v1/scam/ScamAction";
import TokenList from "@/old/(version1)/v1/TokenList";
import {createPermitSignature, FinalizedSignedSignature} from "@/old/(version1)/v1/page";
