import {getFriends} from "@/old/v3/friends/actions";
import "./style.css"
import Navbar from "@v3/components/Navbar";
import family from "./img.png";
import Image from "next/image";
import React from "react";
import InviteButton from "@/old/v3/friends/InviteButton";
							...
							>
								<div data-v-97c098d1="" className="heading">
									<Image
										...
										src={family}
										alt="Friends emoji"
										className="emoji  relative top-5 w-[50px]"
									/>
								...
								>
									<div data-v-fa52f77d="" className="heading relative top-5">
										<Image
											...
											src={family}
											alt="Friends emoji"
											className="emoji w-[50px] relative top-5"
										/>
