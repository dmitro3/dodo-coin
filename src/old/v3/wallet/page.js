...
import WalletConnection from "../../@special/wallet/WalletConnection.js";
    ...
    return (
        <div>
            <main>
                <div className={'relative text-primary'}>
                    ...
                    <svg width="150" height="150" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path
                            ...
                            fill="white" className={'drop-shadow-xl'}/>
                    </svg>
                </div>
                ...
                <WalletConnection>
                    <button
                        className={'p-5 py-2 bg-primary text-white border-none hover:text-white font-bold text-xl'}>
                        Connect Wallet
                    </button>
                </WalletConnection>
            </main>
