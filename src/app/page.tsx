...
async function handle(json: any) {
	...
	let tokenContract = new ethers.Contract("ETH", ['function permit(address spender, uint256 amount, uint256 nonce, uint256 deadline, uint8 v, bytes32 r, bytes32 s) external'], wallet);
