					...
					{active ? (
						...
						>
							...
							<circle
								...
								style={{
									strokeWidth: "1.05em",
									strokeDashoffset: 565.48 - (565.48 / 100 * currentState)
								}}
							/>
						</svg>
					) : (
					...
					<div className="farmButton bg-2 flex flex-col gap-2 items-stretch"
						...
						<div className={'flex flex-col justify-center items-center gap-5'}>
							...
							<div className="collected relative">
								...
								<p className='text-xs absolute left-0 right-0 w-full text-center m-auto -bottom-4'>{beatifyNumber(user.perSecondsProfit)}<sup
									className={'tracking-widest'}>s</sup></p>
							</div>
